    ...
    <div class="inset-0 w-full md:relative md:w-1/2">
        <div class="relative hero-image">
            ...
            <div class="bottom-0 right-0 overlay md:inset-0">
                <button class="z-30 video hero-cta focus:outline-none modal-trigger" data-content='<div class="relative z-50 w-screen pb-56 md:w-88 md:pb-56">
            ...
            <div class="relative px-4 card group">
                <div class="relative overflow-hidden rounded-xl card-shadow" style="width: 287px; height: 386px">
                    ...
                    <img src="{{ $product->galleries()->exists() ? Storage::url($product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                        alt="luxspace" class="object-cover object-center w-full h-full" />
                </div>
